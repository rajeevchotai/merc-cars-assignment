...
public class AESEncryptionManager {
    ...
    public static String encryptString(String key, String data) throws InvalidAlgorithmParameterException,
        ...
        byte [] dataArray=encryptData(key, data.getBytes());
        return Base64.getEncoder()
                .encodeToString(dataArray);
    }

    public static String encryptInteger(String key, Integer data) throws InvalidAlgorithmParameterException,
            NoSuchPaddingException,
            IllegalBlockSizeException,
            NoSuchAlgorithmException,
            BadPaddingException,
    ...
    public static String encryptDouble(String key, Double data) throws InvalidAlgorithmParameterException,
            NoSuchPaddingException,
            IllegalBlockSizeException,
            NoSuchAlgorithmException,
            BadPaddingException,
    ...
    public static String decryptString(String key, String data) throws InvalidAlgorithmParameterException,
            NoSuchPaddingException,
            IllegalBlockSizeException,
            NoSuchAlgorithmException,
            BadPaddingException,
        ...
        byte [] decodedBytes=Base64.getDecoder()
                .decode(data);
        byte [] dataArray=decryptData(key, decodedBytes);
        return new String(dataArray);
    }

    public static Integer decryptInteger(String key, String data) throws InvalidAlgorithmParameterException,
            NoSuchPaddingException,
            IllegalBlockSizeException,
            NoSuchAlgorithmException,
            BadPaddingException,
        ...
        String encryptedString =  decryptString(key, data);
        return Integer.parseInt(encryptedString);
    }

    public static Double decryptDouble(String key, String data) throws InvalidAlgorithmParameterException,
            NoSuchPaddingException,
            IllegalBlockSizeException,
            NoSuchAlgorithmException,
            BadPaddingException,
        ...
        String encryptedString =  decryptString(key, data);
        return Double.parseDouble(encryptedString);
    }
